...
public class Program {
    ...
    public static void plyosavaNat() {
        Plyosova<Integer, String> test = new Plyosova<>(22,"spring");
        Plyosova<Integer, Integer> test2 = new Plyosova<>(2,12);
    }
}